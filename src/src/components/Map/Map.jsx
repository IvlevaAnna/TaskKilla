...
export default function Map() {
    ...
    return (
        <div data-testid="map_global" data-test-id="map-global">
            <div ref={mapContainer} className={styles.mapContainer} data-testid="map_container">
                <button className={styles.closeMapButton} onClick={() => { dispatch(hideMap()) }} data-testid="map_close">
                ...
                <button
                    data-test-id="accept-map-button"
                    onClick={() => { dispatch(setUserAddress(adr1)); dispatch(hideMap()) }} className={styles.acceptAddress} data-testid="map_success"><svg xmlns="http://www.w3.org/2000/svg" width="353" height="289" viewBox="0 0 353 289" fill="none">
